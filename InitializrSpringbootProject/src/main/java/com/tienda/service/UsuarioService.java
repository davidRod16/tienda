...
public class UsuarioService {
    ...
    public void save(Usuario usuario, MultipartFile imagenFile, boolean encriptaClave) {
        ...
        if (usuario.getIdUsuario() == null) {
            ...
            // Conserva los roles existentes del usuario.
            // Los formularios de activación/modificación no envían esta colección.
    ...
    public void delete(Integer idUsuario) {
        ...
        try {
            ...
            // Fuerza a ejecutar el DELETE dentro del try
